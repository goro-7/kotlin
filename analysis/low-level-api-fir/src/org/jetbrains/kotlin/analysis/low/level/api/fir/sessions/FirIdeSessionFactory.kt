...
internal object LLFirSessionFactory {
    fun createSourcesSession(
        ...
        return session.apply session@{
            ...
            register(FirRegisteredPluginAnnotations::class, FirIdeRegisteredPluginAnnotations(this@session, annotationsResolver))
            ...
            // Before registering FirSymbolProvider
            register(
                FirPredicateBasedProvider::class,
                FirIdePredicateBasedProvider(
                    this@session,
                    cache,
                    firFileBuilder,
                    annotationsResolver,
