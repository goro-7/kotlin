...
internal class FirIdePredicateBasedProvider(
    ...
    private fun KtElement.findFirDeclaration(): FirDeclaration? {
        ...
        val fileCache = declarationsCache.getValue(containingKtFile.getCorrespondingFirFile())
        return fileCache.getDeclarationByPsi(this)
    }

    private fun KtFile.getCorrespondingFirFile(): FirFile =
        firFileBuilder.buildRawFirFileWithCaching(this, cache)
