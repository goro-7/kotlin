...
abstract class FirVisitor<out R, in D> {
    ...
    open fun visitSyntheticsAccessorExpression(syntheticsAccessorExpression: FirSyntheticsAccessorExpression, data: D): R  = visitElement(syntheticsAccessorExpression, data)
